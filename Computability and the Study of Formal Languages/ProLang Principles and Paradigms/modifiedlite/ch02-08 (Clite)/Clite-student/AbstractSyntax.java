...
class Program {
    ...
    public void display() {
	int i = 0;
	Indent indent = new Indent(i);
	indent.display("Program ABSTRACT SYNTAX: ");
	
	this.decpart.display(i+1);
	//this.body.display(i+1);
	System.out.println();
	}	
...
class Declarations extends ArrayList<Declaration> {
	...
	Indent localindenter = new Indent(paramInt);
	localindenter.display(getClass().toString().substring(6) + ": ");
	localindenter.display(" Declarations = {");
	String str = "";
	for (Declaration localDeclaration : this) {
		System.out.print(str);
		localDeclaration.display();
		str = ", ";
	}
	System.out.print("}");
	}
...
class Block extends Statement {
	...
	public void display(int paramInt) {
		super.display(paramInt);
		for (Statement localStatement : this.members)
			localStatement.display(paramInt + 1);
	}
}
...
class Assignment extends Statement {
	...
	public void display(int paramInt) {
		super.display(paramInt);
		this.target.display(paramInt + 1);
		this.source.display(paramInt + 1);
	}	
...
// Conditional = Expression test; Statement thenbranch, elsebranch
 ...
 public void display(int pInt) {
	super.display(pInt);
	test.display(pInt + 1 );
	thenbranch.display(pInt + 1);
	elsebranch.display(pInt + 1);
	}
 }   
...
// Binary = Operator op; Expression term1, term2
	...
	public void display(int paramInt) {
		super.display(paramInt);
		this.op.display(paramInt + 1);
		this.term1.display(paramInt + 1);
		this.term2.display(paramInt + 1);
	}
...
class Operator {
    ...
    public void display(int paramInt) {
	Indent localindenter = new Indent(paramInt);
	localindenter.display(getClass().toString().substring(6) + ": " + this.val);
     }
} } 
